...
if True:
  ...
  data = yf.Ticker(f'{crypto_currency}-{against_currency}').history(period="6mo",interval="1h")
  ...
  test_data = yf.Ticker(f'{crypto_currency}-{against_currency}').history(period="1mo",interval="1h")
